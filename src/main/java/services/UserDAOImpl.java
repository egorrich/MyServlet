...
public class UserDAOImpl implements UserDAO {
    ...
    public void create(User user) {
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(Queries.CREATE);
   ...
   /* @Override
    ...
    public User findByName(String name) {
        ...
        User user = new User();
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(Queries.FIND_BY_NAME);
    ...
    public User findById(int id) {
        ...
        User user = new User();
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(Queries.FIND_BY_ID);
